...
<div class="right_col" role="main">
        <h1>Add Visitor <a href="{{route('admin.visitor.index')}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> View All Visitors</a></h1>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('admin.visitor.store')}}" method="POST" class="bg-light p-3">
                                @csrf
                                @method('POST')
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control datetimepicker" name="dateofvisit">
                                            @error('dateofvisit')
                                                <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="concerned_with">Concerned Person: </label>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="reason" id="" cols="30" rows="10" placeholder="Any particular reason to visit.." class="form-control"></textarea>
                                    </div>
