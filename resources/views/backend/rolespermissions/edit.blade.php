...
@endif
    <h1 class="mb-3">Edit Role Permissions for {{$role->name}} <a href="{{route('admin.rolepermission.index')}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> View All Permissions</a></h1>
    <div class="row">
        <div class="col-md-12">
            <div class="card p-3">
                <form action="{{route('admin.rolepermission.update', $rolepermission->id)}}" method="POST" class="p-3">
                    @csrf
                    @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="userpermission" style="font-size: 20px;">User and Position Permissions:</label>
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 1)==1?'checked':''}}>
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 2)==1?'checked':''}}>
                                            <label class="form-check-label">
                                                Manage Users
                                            </label>
                                            @error('permission[]')
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 3)==1?'checked':''}}>
                                            <label class="form-check-label">
                                                Manage Positions
                                            </label>
                                            @error('permission[]')
                                ...
                                <div class="form-group">
                                    <label for="staffpermission" style="font-size: 20px;">Staff Permissions:</label>
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 4)==1?'checked':''}}>
                                            <label class="form-check-label">
                                                Manage Staff
                                            </label>
                                            @error('permission[]')
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 5)==1?'checked':''}}>
                                            <label class="form-check-label">
                                                Manage Staff Salary
                                            </label>
                                            @error('permission[]')
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 6)==1?'checked':''}}>
                                            <label class="form-check-label">
                                                Staff Salary Report
                                            </label>
                                            @error('permission[]')
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 7)==1?'checked':''}}>
                                            <label class="form-check-label">
                                ...
                                <div class="form-group">
                                    <label for="clientpermission" style="font-size: 20px;">Project and Client Permissions:</label>
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 8)==1?'checked':''}}>
                                            <label class="form-check-label">
                                                View Clients
                                            </label>
                                            @error('permission[]')
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 9)==1?'checked':''}}>
                                            <label class="form-check-label">
                                                Manage Clients
                                            </label>
                                            @error('permission[]')
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 10)==1?'checked':''}}>
                                            <label class="form-check-label">
                                                View Projects
                                            </label>
                                            @error('permission[]')
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 11)==1?'checked':''}}>
                                            <label class="form-check-label">
                                                Manage Projects
                                            </label>
                                            @error('permission[]')
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 12)==1?'checked':''}}>
                                            <label class="form-check-label">
                                ...
                                <div class="form-group">
                                    <label for="otherpermission" style="font-size: 20px;">Other Permissions:</label>
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 13)==1?'checked':''}}>
                                            <label class="form-check-label">
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 14)==1?'checked':''}}>
                                            <label class="form-check-label">
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 15)==1?'checked':''}}>
                                            <label class="form-check-label">
                                                Manage Visitors
                                            </label>
                                            @error('permission[]')
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 16)==1?'checked':''}}>
                                            <label class="form-check-label">
                                                Manage Permissions
                                            </label>
                                            @error('permission[]')
                                        ...
                                        <div class="form-group ml-3">
                                            ...
                                            {{checkpermission($role->id, 17)==1?'checked':''}}>
                                            <label class="form-check-label">
                                                Send Email
                                            </label>
                                            @error('permission[]')
