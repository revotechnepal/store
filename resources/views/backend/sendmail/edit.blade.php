...
@section('content')
    <div class="right_col" role="main">
            ...
            @endif
            <h1>Edit Mail Format <a href="{{route('admin.mail.index')}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> View All Mail Format</a></h1>
        <div class="card">
                  <div class="card-body">
                        <form action="{{route('admin.mail.update', $mailformat->id)}}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" placeholder="Offer Letter" value="{{$mailformat->title}}">
                                        @error('title')
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <textarea name="message" class="form-control summernote" placeholder="Compose your message..">{{$mailformat->message}}</textarea>
                                    @error('message')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                                <div class="col-md-12 mt-3">
                                    <button type="submit" class="btn btn-success">Update Format</button>
                                </div>
