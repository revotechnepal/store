...
{{-- @if (session('success'))
            ...
            @endif
            <h1 class="mt-3">Product Categories <a href="{{route('admin.category.create')}}" class="btn btn-primary btn-sm"> <i class="fa fa-plus" aria-hidden="true"></i> Add New Category</a></h1>
            <div class="card mt-3">
