...
{{-- @if (session('success'))
            ...
            @endif
            <h1 class="mt-3">All Invoices <a href="{{route('admin.payment.create')}}" class="btn btn-primary btn-sm"> <i class="fa fa-plus" aria-hidden="true"></i> Make new Payment</a></h1>
            <div class="card mt-3">
                    ...
                    <table class="table table-bordered yajra-datatable text-center">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Empoyee </th>
