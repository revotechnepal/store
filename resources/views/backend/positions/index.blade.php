...
{{-- @if (session('success'))
            ...
            @endif
            <h1 class="mt-3">View Position <a href="{{route('admin.position.create')}}" class="btn btn-primary btn-sm"> <i class="fa fa-plus" aria-hidden="true"></i> Add New Position</a></h1>
            <div class="card mt-3">
