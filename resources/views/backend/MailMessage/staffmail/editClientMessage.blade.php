    ...
    <div class="right_col" role="main">
        ...
        <div class="card">
            <div class="card-header text-center">
                <h3>Edit Compose For Client</h3>
            </div>
            <div class="card-body">
                <form action="{{route('admin.client.message.update')}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-12 mt-3">
                            <textarea name="messagetoclient" class="form-control summernote" placeholder="Compose your message..">{{$messagetostaff->mailtoclient}}</textarea>
                        </div>
                        <div class="col-md-12 mt-3">
