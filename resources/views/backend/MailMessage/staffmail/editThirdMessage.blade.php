...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('admin.third.message.update')}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-12 mt-3">
                            <textarea name="messagetothirdparty" class="form-control summernote" placeholder="Compose your message..">{{$messagetostaff->mailtothirdparty}}</textarea>
                        </div>
                        <div class="col-md-12 mt-3">
