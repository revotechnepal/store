...
Route::group(['prefix'=>'admin','as'=>'admin.','middleware' => ['auth', 'roles']], function(){
    ...
    Route::resource('pos', PosSalesController::class);
    Route::resource('ledger', LedgerController::class);
    Route::get('ledgergenerator', [LedgerController::class, 'ledgergenerator'])->name('ledgergenerator');
    Route::get('ledgerreport', [LedgerController::class, 'ledgerreport'])->name('ledgerreport');
